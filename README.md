...
> Be patient! In ~3 mins your app is live, at your [app url](https://container-8faru0a.containers.anotherwebservice.com/). It even has a free SSL/TLS certificate 🔒 you're welcome!
...
Your app will be automatically re-deployed with the latest code at: https://container-8faru0a.containers.anotherwebservice.com/
...
```
git clone git@github.com:kingsiddhu/container-8faru0a.git
cd container-8faru0a
```
...
```
docker attach container-8faru0a
```
